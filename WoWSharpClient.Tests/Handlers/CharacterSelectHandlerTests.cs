...
namespace WoWSharpClient.Tests.Handlers
{
    public class CharacterSelectHandlerTests
    {
        ...
        public CharacterSelectHandlerTests()
        {
            ...
            _characterSelectHandler = new CharacterSelectHandler(_woWSharpEventEmitterMock.Object, _objectManagerMock);
        }

        [Fact]
        public void ShouldParseCharacterList()
        {
            var opcode = Opcodes.SMSG_CHAR_ENUM;
            ...
            Assert.Equal(10, _objectManagerMock.CharacterSelects.Count);
            ...
            {
                var parsedCharacter = _objectManagerMock.CharacterSelects.First(o => o.Guid == expectedCharacter.Guid);
