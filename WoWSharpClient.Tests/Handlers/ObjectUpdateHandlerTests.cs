...
namespace WoWSharpClient.Tests.Handlers
{
    public class ObjectUpdateHandlerTests
    {
        ...
        public void ShouldDecompressAndParseTransports()
        {
            ...
            Assert.Equal(6, _objectManagerMock.Objects.Count);
            ...
            var addedObject3 = (GameObject)_objectManagerMock.Objects.First(o => o.Guid == expectedGuid3);
            ...
            var addedObject6 = (GameObject)_objectManagerMock.Objects.First(o => o.Guid == expectedGuid6);
        ...
        public void ShouldDecompressAndParsePlayerCharacter()
        {
            ...
            // Verify that objects with the expected GUIDs were added to the ObjectManager
            Assert.Equal(31, _objectManagerMock.Objects.Count);

            // First object (Item)
            var item1 = (Item)_objectManagerMock.Objects[0];
            ...
            Assert.Equal(0u, item1.Timestamp);
            ...
            Assert.Equal(ItemDynFlags.ITEM_DYNFLAG_BINDED, item1.Flags);
            ...
            // Second object (Item)
            var item2 = (Item)_objectManagerMock.Objects[1];
            ...
            Assert.Equal(0u, item2.Timestamp);
            ...
            Assert.Equal(ItemDynFlags.ITEM_DYNFLAG_BINDED, item2.Flags);
            ...
            // Third object (Item)
            var item3 = (Item)_objectManagerMock.Objects[2];
            ...
            Assert.Equal(0u, item3.Timestamp);
            ...
            Assert.Equal(ItemDynFlags.ITEM_DYNFLAG_BINDED, item3.Flags);
            ...
            // Fourth object (Item)
            var item4 = (Item)_objectManagerMock.Objects[3];
            ...
            Assert.Equal(0u, item4.Timestamp);
            ...
            Assert.Equal((ItemDynFlags)0, item4.Flags);
            ...
            // Fifth object (Item)
            var item5 = (Item)_objectManagerMock.Objects[4];
            ...
            Assert.Equal(0u, item5.Timestamp);
            ...
            Assert.Equal(ItemDynFlags.ITEM_DYNFLAG_BINDED, item5.Flags);
            ...
            // Sixth object (Item)
            var item6 = (Item)_objectManagerMock.Objects[5];
            ...
            Assert.Equal(0u, item6.Timestamp);
            ...
            Assert.Equal(ItemDynFlags.ITEM_DYNFLAG_BINDED, item6.Flags);
            ...
            // Seventh object (Item)
            var item7 = (Item)_objectManagerMock.Objects[6];
            ...
            Assert.Equal(0u, item7.Timestamp);
            ...
            Assert.Equal(ItemDynFlags.ITEM_DYNFLAG_BINDED, item7.Flags);
            ...
            // Eighth object (Item)
            var item8 = (Item)_objectManagerMock.Objects[7];
            ...
            Assert.Equal(0u, item8.Timestamp);
            ...
            Assert.Equal(ItemDynFlags.ITEM_DYNFLAG_BINDED, item8.Flags);
            ...
            // Ninth object (Item)
            var item9 = (Item)_objectManagerMock.Objects[8];
            ...
            Assert.Equal(0u, item9.Timestamp);
            ...
            Assert.Equal(ItemDynFlags.ITEM_DYNFLAG_BINDED, item9.Flags);
            ...
            // Tenth object (Item)
            var item10 = (Item)_objectManagerMock.Objects[9];
            ...
            Assert.Equal(0u, item10.Timestamp);
            ...
            Assert.Equal(ItemDynFlags.ITEM_DYNFLAG_BINDED, item10.Flags);
            ...
            // Eleventh object (Item)
            var item11 = (Item)_objectManagerMock.Objects[10];
            ...
            Assert.Equal(0u, item11.Timestamp);
            ...
            Assert.Equal(ItemDynFlags.ITEM_DYNFLAG_BINDED, item11.Flags);
            ...
            // Twelfth object (Item)
            var item12 = (Item)_objectManagerMock.Objects[11];
            ...
            Assert.Equal(0u, item12.Timestamp);
            ...
            Assert.Equal(ItemDynFlags.ITEM_DYNFLAG_BINDED, item12.Flags);
            ...
            // Thirteenth object (Item)
            var item13 = (Item)_objectManagerMock.Objects[12];
            ...
            Assert.Equal(0u, item13.Timestamp);
            ...
            Assert.Equal(ItemDynFlags.ITEM_DYNFLAG_BINDED, item13.Flags);
            ...
            // Fourteenth object (Item)
            var item14 = (Item)_objectManagerMock.Objects[13];
            ...
            Assert.Equal(0u, item14.Timestamp);
            ...
            Assert.Equal(ItemDynFlags.ITEM_DYNFLAG_BINDED, item14.Flags);
            ...
            // Fifteenth object (Item)
            var item15 = (Item)_objectManagerMock.Objects[14];
            ...
            Assert.Equal(0u, item15.Timestamp);
            ...
            Assert.Equal(ItemDynFlags.ITEM_DYNFLAG_BINDED, item15.Flags);
            ...
            // Sixteenth object (Item)
            var item16 = (Item)_objectManagerMock.Objects[15];
            ...
            Assert.Equal(0u, item16.Timestamp);
            ...
            Assert.Equal(ItemDynFlags.ITEM_DYNFLAG_BINDED, item16.Flags);
            ...
            // Seventeenth object (Item)
            var item17 = (Item)_objectManagerMock.Objects[16];
            ...
            Assert.Equal(0u, item17.Timestamp);
            ...
            Assert.Equal(ItemDynFlags.ITEM_DYNFLAG_BINDED, item17.Flags);
            ...
            // Eighteenth object (Item)
            var item18 = (Item)_objectManagerMock.Objects[17];
            ...
            Assert.Equal(0u, item18.Timestamp);
            ...
            Assert.Equal(ItemDynFlags.ITEM_DYNFLAG_BINDED, item18.Flags);
            ...
            // Nineteenth object (Item)
            var item19 = (Item)_objectManagerMock.Objects[18];
            ...
            Assert.Equal(0u, item19.Timestamp);
            ...
            Assert.Equal(ItemDynFlags.ITEM_DYNFLAG_BINDED, item19.Flags);
            ...
            var container20 = (Container)_objectManagerMock.Objects[19];
            ...
            Assert.Equal(0u, container20.Timestamp);
            ...
            Assert.Equal(ItemDynFlags.ITEM_DYNFLAG_BINDED, container20.Flags);
            ...
            // Twenty-first object (Item)
            var item21 = (Item)_objectManagerMock.Objects[20];
            ...
            Assert.Equal(0u, item21.Timestamp);
            ...
            Assert.Equal(ItemDynFlags.ITEM_DYNFLAG_BINDED, item21.Flags);
            ...
            var container22 = (Container)_objectManagerMock.Objects[21];
            ...
            Assert.Equal(0u, container22.Timestamp);
            ...
            Assert.Equal((ItemDynFlags)0, container22.Flags);
            ...
            // Twenty-third object (Item)
            var item23 = (Item)_objectManagerMock.Objects[22];
            ...
            Assert.Equal(0u, item23.Timestamp);
            ...
            Assert.Equal(ItemDynFlags.ITEM_DYNFLAG_BINDED, item23.Flags);
            ...
            var container24 = (Container)_objectManagerMock.Objects[23];
            ...
            Assert.Equal(0u, container24.Timestamp);
            ...
            Assert.Equal((ItemDynFlags)0, container24.Flags);
            ...
            // Twenty-fifth object (Item)
            var item25 = (Item)_objectManagerMock.Objects[24];
            ...
            Assert.Equal(0u, item25.Timestamp);
            ...
            Assert.Equal((ItemDynFlags)0, item25.Flags);
            ...
            var container26 = (Container)_objectManagerMock.Objects[25];
            ...
            Assert.Equal(0u, container26.Timestamp);
            ...
            Assert.Equal(ItemDynFlags.ITEM_DYNFLAG_BINDED, container26.Flags);
            ...
            // Twenty-seventh object (Item)
            var item27 = (Item)_objectManagerMock.Objects[26];
            ...
            Assert.Equal(0u, item27.Timestamp);
            ...
            Assert.Equal(ItemDynFlags.ITEM_DYNFLAG_BINDED, item27.Flags);
            ...
            // Twenty-eighth object (Item)
            var item28 = (Item)_objectManagerMock.Objects[27];
            ...
            Assert.Equal(0u, item28.Timestamp);
            ...
            Assert.Equal(ItemDynFlags.ITEM_DYNFLAG_BINDED, item28.Flags);
            ...
            // Twenty-ninth object (Item)
            var item29 = (Item)_objectManagerMock.Objects[28];
            ...
            Assert.Equal(0u, item29.Timestamp);
            ...
            Assert.Equal(ItemDynFlags.ITEM_DYNFLAG_BINDED, item29.Flags);
            ...
            var player = (Player)_objectManagerMock.Objects[30];
            ...
            Assert.Equal(0u, player.Timestamp);
