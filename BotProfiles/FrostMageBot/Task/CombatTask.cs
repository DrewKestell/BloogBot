...
namespace FrostMageBot
{
    class CombatTask : CombatRotationTask, IBotTask
    {
        ...
        internal CombatTask(IClassContainer container, Stack<IBotTask> botTasks, List<WoWUnit> targets) : base(container, botTasks, targets, 29 + (ObjectManager.Instance.Player.GetTalentRank(3, 11) * 3))
        {
        ...
        public new void Update()
        {
            ...
            if (wand != null && player.ManaPercent <= 10 && player.Casting == 0 && player.Channeling == 0)
