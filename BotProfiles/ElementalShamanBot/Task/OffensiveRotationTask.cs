...
{
    class OffensiveRotationTask : CombatRotationTask, IBotTask
    {
        ...
        internal OffensiveRotationTask(IClassContainer container, Stack<IBotTask> botTasks, List<WoWUnit> targets) : base(container, botTasks, targets, 30)
        {
