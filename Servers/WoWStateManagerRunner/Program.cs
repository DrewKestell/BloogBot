            ...
            if (activityCommand.ActivityAction != ActivityAction.None)
            {
                ...
                switch (activityCommand.ActivityAction)
                {
                    ...
                    case ActivityAction.EditActivityMember:
                        ...
                        {
                            case "BotProfileName":
                                activityMemberPreset.BotProfileName = activityCommand.CommandParam4;
                                break;
                            case "AccountName":
                                activityMemberPreset.AccountName = activityCommand.CommandParam4;
                                break;
                            case "BeginStateConfigName":
                                activityMemberPreset.BeginStateConfigName = activityCommand.CommandParam4;
                                break;
                            case "EndStateConfigName":
                                activityMemberPreset.EndStateConfigName = activityCommand.CommandParam4;
                                break;
                            case "Remove":
