...
using System.Text;
using WoWActivityManager.Utilities;
using static WoWActivityManager.WinImports;

namespace WoWActivityManager
{
    public class WoWClientBotLauncher
    {
        public static WoWClientBotLauncher Instance { get; private set; } = new WoWClientBotLauncher();

        private WoWClientBotLauncher() { }
