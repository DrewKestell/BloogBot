...
{
    public class LocalPlayer : WoWPlayer, ILocalPlayer
    {
        ...
        public Class Class => (Class)MemoryManager.ReadByte(MemoryAddresses.LocalPlayerClass);
        public Race Race => Enum.GetValues(typeof(Race))
                .Cast<Race>()
        ...
        public void RefreshSpells()
        {
            ...
            for (var i = 0; i < 1024; i++)
            {
                ...
                if (PlayerSpells.TryGetValue(name, out int[]? value))
                    PlayerSpells[name] = new List<int>(value)
                    {
                        currentSpellId
                    }.ToArray();
                else
        ...
        int ILocalPlayer.ComboPoints => throw new NotImplementedException();

        int ILocalPlayer.ChannelingId => throw new NotImplementedException();
