...
{
    public class WoWUnit : WoWGameObject
    {
        public WoWUnit(byte[] lowGuid, byte[] highGuid, WoWObjectType objectType = WoWObjectType.Unit)
        ...
        public Dictionary<Powers, int> Power { get; set; }

        public Dictionary<Powers, int> MaxPower { get; set; }

        public int Mana
        {
            get => Power.ContainsKey(Powers.MANA) ? Power[Powers.MANA] : 0;
            set => Power[Powers.MANA] = value;
        }

        public int MaxMana
        {
            get => MaxPower.ContainsKey(Powers.MANA) ? MaxPower[Powers.MANA] : 0;
            set => MaxPower[Powers.MANA] = value;
        }
        ...
        public float BaseMinDamage { get; set; } = 1.0f;

        public float BaseMaxDamage { get; set; } = 2.0f;

        public float BaseAttackTime { get; set; } = 2000;
        ...
        public List<Spell> Buffs { get; set; }

        public List<Spell> Debuffs { get; set; }
        ...
        public void CastSpell(WoWUnit target, int spellId, bool triggered)
        {
        ...
        public void Attack(WoWUnit victim, bool meleeAttack)
        {
        ...
        public void SetPower(Powers powerType, int value)
        {
        ...
        public void SetMaxPower(Powers powerType, int value)
        {
