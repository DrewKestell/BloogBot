    ...
    public static class MemoryAddresses
    {
        static MemoryAddresses()
        {
            if (ClientHelper.ClientVersion == ClientVersion.WotLK)
            {
                ...
                GetPlayerGuidFunPtr = 0x0; // not used in WotLK. we can get the PlayerGuid by static memory address
                ...
                ZoneTextPtrAddr = 0x00BD0788;
                SubZoneTextPtrAddr = 0x00BD0784;
                MinimapZoneTextPtrAddr = 0x00BD077C;
                MapIdAddr = 0x00AB63BC;
                ServerNameAddr = 0x004DD900;
                ...
                LocalPlayer_LastHardwareAction = 0x00B499A4;
                ...
                WoWObject_GetPositionFunOffset = 0x2C;
                WoWObject_GetFacingFunOffset = 0x34;
