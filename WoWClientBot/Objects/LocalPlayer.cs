using ObjectManager = WoWClientBot.Game.Statics.ObjectManager;
using Functions = WoWClientBot.Mem.Functions;
...
namespace WoWClientBot.Objects
{
    public class LocalPlayer : WoWPlayer
    {
        ...
        public int GetManaCost(string spellName, int rank = -1)
        {
            ...
            var entryPtr = MemoryManager.ReadIntPtr((IntPtr)((uint)(MemoryManager.ReadUint(0x00C0D780 + 8) + parId * 4)));
