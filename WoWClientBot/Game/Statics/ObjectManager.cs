...
namespace WoWClientBot.Game.Statics
{
        ...
        static void UpdateProbe()
        {
            try
            {
                if (IsLoggedIn)
                {
                    ...
                    _characterState.CharacterConfig.Level = Player.Level;
                    ...
                    _characterState.CharacterConfig.Spells = Player.PlayerSpells.Values.SelectMany(x => x).OrderBy(x => x).ToList();
                    _characterState.CharacterConfig.Skills = Player.PlayerSkills.OrderBy(x => x).ToList();
                    ...
                    if (headItem != null)
                    {
                        _characterState.CharacterConfig.HeadItem = headItem.ItemId;
                    }
                    else
                    {
                        _characterState.CharacterConfig.HeadItem = 0;
                    }
                    if (neckItem != null)
                    {
                        _characterState.CharacterConfig.NeckItem = neckItem.ItemId;
                    }
                    else
                    {
                        _characterState.CharacterConfig.NeckItem = 0;
                    }
                    if (shoulderItem != null)
                    {
                        _characterState.CharacterConfig.ShoulderItem = shoulderItem.ItemId;
                    }
                    else
                    {
                        _characterState.CharacterConfig.ShoulderItem = 0;
                    }
                    if (backItem != null)
                    {
                        _characterState.CharacterConfig.BackItem = backItem.ItemId;
                    }
                    else
                    {
                        _characterState.CharacterConfig.BackItem = 0;
                    }
                    if (chestItem != null)
                    {
                        _characterState.CharacterConfig.ChestItem = chestItem.ItemId;
                    }
                    else
                    {
                        _characterState.CharacterConfig.ChestItem = 0;
                    }
                    if (shirtItem != null)
                    {
                        _characterState.CharacterConfig.ShirtItem = shirtItem.ItemId;
                    }
                    else
                    {
                        _characterState.CharacterConfig.ShirtItem = 0;
                    }
                    if (tabardItem != null)
                    {
                        _characterState.CharacterConfig.TabardItem = tabardItem.ItemId;
                    }
                    else
                    {
                        _characterState.CharacterConfig.TabardItem = 0;
                    }
                    if (wristItem != null)
                    {
                        _characterState.CharacterConfig.WristsItem = wristItem.ItemId;
                    }
                    else
                    {
                        _characterState.CharacterConfig.WristsItem = 0;
                    }
                    if (handsItem != null)
                    {
                        _characterState.CharacterConfig.HandsItem = handsItem.ItemId;
                    }
                    else
                    {
                        _characterState.CharacterConfig.HandsItem = 0;
                    }
                    if (waistItem != null)
                    {
                        _characterState.CharacterConfig.WaistItem = waistItem.ItemId;
                    }
                    else
                    {
                        _characterState.CharacterConfig.WaistItem = 0;
                    }
                    if (legsItem != null)
                    {
                        _characterState.CharacterConfig.LegsItem = legsItem.ItemId;
                    }
                    else
                    {
                        _characterState.CharacterConfig.LegsItem = 0;
                    }
                    if (feetItem != null)
                    {
                        _characterState.CharacterConfig.FeetItem = feetItem.ItemId;
                    }
                    else
                    {
                        _characterState.CharacterConfig.FeetItem = 0;
                    }
                    if (finger1Item != null)
                    {
                        _characterState.CharacterConfig.Finger1Item = finger1Item.ItemId;
                    }
                    else
                    {
                        _characterState.CharacterConfig.Finger1Item = 0;
                    }
                    if (finger2Item != null)
                    {
                        _characterState.CharacterConfig.Finger2Item = finger2Item.ItemId;
                    }
                    else
                    {
                        _characterState.CharacterConfig.Finger2Item = 0;
                    }
                    if (trinket1Item != null)
                    {
                        _characterState.CharacterConfig.Trinket1Item = trinket1Item.ItemId;
                    }
                    else
                    {
                        _characterState.CharacterConfig.Trinket1Item = 0;
                    }
                    if (trinket2Item != null)
                    {
                        _characterState.CharacterConfig.Trinket2Item = trinket2Item.ItemId;
                    }
                    else
                    {
                        _characterState.CharacterConfig.Trinket2Item = 0;
                    }
                    if (mainHandItem != null)
                    {
                        _characterState.CharacterConfig.MainHandItem = mainHandItem.ItemId;
                    }
                    else
                    {
                        _characterState.CharacterConfig.MainHandItem = 0;
                    }
                    if (offHandItem != null)
                    {
                        _characterState.CharacterConfig.OffHandItem = offHandItem.ItemId;
                    }
                    else
                    {
                        _characterState.CharacterConfig.OffHandItem = 0;
                    }
                    if (rangedItem != null)
                    {
                        _characterState.CharacterConfig.RangedItem = rangedItem.ItemId;
                    }
                    else
                    {
                        _characterState.CharacterConfig.RangedItem = 0;
                    }
                }
            }
            catch (Exception ex)
