...
namespace FrostMageBot
{
    class CombatTask : CombatRotationTask, IBotTask
    {
        ...
        internal CombatTask(IClassContainer container, Stack<IBotTask> botTasks, List<WoWUnit> targets) : base(container, botTasks, targets, 29 + (ObjectManager.GetTalentRank(3, 11) * 3))
        {
