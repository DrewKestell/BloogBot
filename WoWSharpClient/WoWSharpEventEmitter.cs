...
namespace WoWSharpClient
{
    public class WoWSharpEventEmitter : IWoWEventHandler
    {
        ...
        internal void FireOnChatMessage(ChatSenderType unitType, string chatTag, string unitName, string chatChannel, string message) => FireEvent(OnChatMessage, new ChatMessageArgs(unitType, chatTag, unitName, chatChannel, message));
