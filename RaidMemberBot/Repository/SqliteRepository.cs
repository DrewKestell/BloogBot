                ...
                using (var reader = command.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        GameObject gameObject = new GameObject()
                        {
                            ...
                            LocationX = reader.GetFloat(reader.GetOrdinal("position_x")),
                            LocationY = reader.GetFloat(reader.GetOrdinal("position_y")),
                            LocationZ = reader.GetFloat(reader.GetOrdinal("position_z")),
